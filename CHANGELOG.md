...
- Improve idle detection and fix cloud-init write_files failure
## [3.11.0] - 2026-03-24

### Added

- Add snapshot lifecycle hooks for session persistence
- Add toast notifications for guest copy link and revoke
## [3.10.0] - 2026-03-24
...
- Snapshot server before auto-delete and restore from snapshot
## [3.7.0] - 2026-03-16

### Added

- Add Cloudflare DNS auto-update and fixed SSH host key
## [3.6.2] - 2026-03-13
...
- Open overview page service links in new tab
## [3.4.2] - 2026-02-19

### Fixed

- Setup pnpm before node cache in release workflow
## [3.4.1] - 2026-02-19
...
- Add e2e, component, property-based, and security tests
## [3.3.1] - 2026-02-16
